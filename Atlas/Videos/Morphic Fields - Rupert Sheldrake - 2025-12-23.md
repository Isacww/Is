---
date: 2025-12-23
video: Morphic Fields - Rupert Sheldrake
tags:
  - video
  - fields
---
...
Examples include rats learning mazes faster due to resonance; experiments showed improvement across locations (Harvard, Edinburgh, Melbourne), with speed-ups as more rats learned, indicating collective memory. New compounds are hard to crystallize initially but become easier worldwide as more form them, not due to dust but resonance. Wordle puzzles are harder in the morning than evening as more people solve them. Times crossword puzzles get easier after publication. Crystallization eases over time, and melting points of new compounds rise gradually. Slime mold (Physarum polycephalum) in mazes finds optimal paths; repeated experiments might show faster learning via resonance. These examples are repeated to illustrate testable predictions, such as plotting number of learners vs. speed for new individuals, or measuring field strength via effect magnitude.
...
File creation date: 2025-12-23 11:24  
Last Modified: 2025-12-23 11:24